...
<tr>
<td align="center">
<img src="https://github.com/user-attachments/assets/a21ed8fc-9e3b-4570-87a7-f88bd218cf27" alt="Main Interface" width="400"/>
...
|:--------:|:--------:|:----:|
| 🪟 **Windows** | [2FAS-Decryption-Tool.exe](https://github.com/AlexanderQueen/2fas-gui-backup-decryption-tool/releases/latest/download/2FAS-Decryption-Tool.exe) | ~35MB |
| 🍎 **macOS** | [2FAS-Decryption-Tool.dmg](https://github.com/AlexanderQueen/2fas-gui-backup-decryption-tool/releases/latest/download/2FAS-Decryption-Tool.dmg) | TBD |
| 🐧 **Linux** | [2FAS-Decryption-Tool](https://github.com/AlexanderQueen/2fas-gui-backup-decryption-tool/releases/latest/download/2FAS-Decryption-Tool) | TBD |
